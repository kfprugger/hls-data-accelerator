            ...
            if isinstance(res_resp, dict) and "definition" in res_resp:
                ...
                for part in parts:
                    ...
                    if path == "notebook-content.py":
                        ...
                        print(decoded[:2500])
                        with open("/Users/joey/git/hls-data-accelerator/scratch/ingestion_notebook_code.py", "w", encoding="utf-8") as out:
                            out.write(decoded)
                        print("\nWrote full code to /Users/joey/git/hls-data-accelerator/scratch/ingestion_notebook_code.py")
                        return
