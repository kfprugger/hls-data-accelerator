...
> Before running this phase, ensure Stage 3 is complete, the Fabric tenant previews for Ontology and Data Activator are enabled, and the HDS Silver Lakehouse has OneLake security disabled. See the root [Prerequisites](../README.md#prerequisites).
