...
### Full Deploy (RTI → automated HDS source → Phase 2+3)
```powershell
cd C:\git\hls-data-accelerator
.\Deploy-All.ps1 `
...
### Phase 2 Only (after the HDS source contract is complete)
```powershell
...
| 5 | 3 | Microsoft HDS/DTT v1.4.0 source deployment and validation | ~15-45 min |
...
## Invoking HDS Pipelines for Diagnostics
