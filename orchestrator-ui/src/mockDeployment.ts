...
const MOCK_PHASES: MockPhase[] = [
  ...
  {
    phase: "3. HDS Bridge + Row Gates: HDS Source Deployment",
    durationMs: 9000,
    logs: [
      { delayPct: 0, level: "info", message: "Building Microsoft HDS 1.4.0 and DTT 0.3.1.1271 wheels…" },
      { delayPct: 15, level: "success", message: "Validated immutable HDS source payload" },
      { delayPct: 25, level: "info", message: "Uploading hds-build-artifacts to deployment_lakehouse…" },
      { delayPct: 45, level: "success", message: "OneLake artifact upload complete" },
      { delayPct: 55, level: "info", message: "Importing deployment and validation notebooks…" },
      { delayPct: 65, level: "info", message: "Publishing healthcare1_environment…" },
      { delayPct: 78, level: "success", message: "Environment published with hds, dtt, and scipy 1.11.4" },
      { delayPct: 85, level: "info", message: "Running master_deployer and Microsoft validators…" },
      { delayPct: 98, level: "success", message: "HDS v1.4.0 source contract validated" },
    ],
  },
  // ── Phase 2 ──
  {
