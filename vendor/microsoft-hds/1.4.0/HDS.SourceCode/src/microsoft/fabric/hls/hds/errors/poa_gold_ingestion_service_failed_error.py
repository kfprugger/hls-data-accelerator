...
class PatientOutreachGoldIngestionServiceFailedError(BaseRunnableServiceFailedError):
    """Exception raised for errors during POA Gold ingestion.
    ...
    def __init__(self, message="POA Gold Ingestion Failed.", exceptions=None):
